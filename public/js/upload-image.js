$(document).ready(function (e) {
  ...
  $('#file').change(function() {
    ...
    if ( file.size > maxsize )
    {
      ...
      $('#message').html('<div class=\"alert alert-danger\" role=\"alert\">Lähettämäsi kuvatiedosto on liian suuri. Tiedoston maksimikoko on ' + (maxsize/1024/1024).toFixed(2) + ' Mt</div>');
